        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            ...
            <div class="w-full container mx-auto flex  sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-6 py-2">
                <div> <a href="{{route('home')}}" class="hover:bg-blue-700 rounded py-2 px-4 mx-2 hover:text-white">Home</a>
                    ...
                    @endforeach
                    <a href="{{route('about-us')}}" class="hover:bg-blue-700 hover:text-white rounded py-2 px-4 mx-2">About us</a>
                   </div>
                   <div>
                    @auth
                <div class="flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="hover:bg-blue-700 hover:text-white rounded py-2 px-4 mx-2 flex items-center">
                ...
                <a href="{{route('login')}}" class="hover:bg-blue-700 hover:text-white rounded py-2 px-4 mx-2">Login</a>
                <a href="{{route('register')}}" class="bg-blue-700 text-white rounded py-2 px-4 mx-2">Register</a>
